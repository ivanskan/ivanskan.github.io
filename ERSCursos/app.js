let data = [];
  ...
  document.getElementById("btnBuscar").innerText = "Ingresar";
  });
  ...
  // Mostrar logo header
  document.getElementById('logoHeader').classList.remove("d-none");
  ...
  // Ocultar logo otra vez
  document.getElementById('logoHeader').classList.add("d-none");
